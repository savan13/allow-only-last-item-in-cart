...
Upload the allow_only_last_item_in_cart plugin to your plugin directory, activate it
...
= 1.0.0 =
A New release there is no Upgrade notices 
...
`<?php allow_only_last_item_in_cart (); // goes in backticks ?>`
