 ...
 * Description:       This Plugin gives you the functionality when the user clicks on Add to Cart button it will clear all previous cart data entirely and add new cart data, only allow one product purchase at a time.
 * Version:           1.0.0
 * Author:            Virtual Height IT Services Ltd
 * Author URI:        https://www.virtualheight.com/plugin
 * License:           GPL-2.0+
